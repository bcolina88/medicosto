  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li ><a href="{{ route('profesionales.index') }}"><i class="fa fa-group"></i> <span>Profesionales</span></a></li>
        @endif
        ...
        <li class="treeview">
              <a href="#"> <i class="fa fa-money"></i> Liquidaciones
              ...
              <ul class="treeview-menu">
                  ...
                  @if(\App\Http\Controllers\RolesController::ver(8))
                  <li><a href="{{ route('liquidaciones.index') }}"><i class="fa fa-circle"></i> Listado de Liquidaciones</a></li>
                  @endif
        ...
        <li class="treeview">
              <a href="#"> <i class="fa fa-medkit"></i> Obras Sociales
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                  ...
                  <li><a href="{{ route('obras.create') }}"><i class="fa fa-circle"></i> Crear Obra Social</a></li>
                  @endif
   

                  @if(\App\Http\Controllers\RolesController::ver(2))
                  <li><a href="{{ route('obras.index') }}"><i class="fa fa-circle"></i> Listado de Obra Social</a></li>
                  @endif
        ...
        <li class="treeview">
              <a href="#"> <i class="fa fa-money"></i> Pagos de Obras Soc.
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                   ...
                   <li><a href="{{ route('pagos.create') }}"><i class="fa fa-circle"></i> Crear Pago</a></li>
                   @endif


                   @if(\App\Http\Controllers\RolesController::agregar(9))
                   <li><a href="{{ route('pagos.index') }}"><i class="fa fa-circle"></i> Listado de Pagos</a></li>
        		   @endif
