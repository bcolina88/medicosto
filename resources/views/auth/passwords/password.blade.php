    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" >
            ...
            <br><br><br><br>
            <div class="swal-title">La contraseña fue cambianda con exito.</div>
            <div style="text-align: center;font-size: 16px;" >Debe salir del sistema y usar su nueva contraseña.</div>
            <br><br><br><br>
        </div>
